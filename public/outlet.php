...
$out = mysqli_fetch_assoc($outlet);

if (isset($_POST['send'])) {
  if (addOutlet($_POST)) {
    echo "<script> alert('Berhasil!'); document.location = 'outlet'; </script>";
  } else {
    echo '<script> alert("Gagal"); document.location = "outlet"; </script>';
  }
}
        ...
        <div class="carda card">
          ...
          <div class="card-body">
            <form action="" method="post">
              ...
              <div class="mb-3">
                <label for="kelamin" class="form-label">Telpon :</label>
                <input type="number" name="telp" id="tlp" class="form-control">
              </div>
          </div>
              ...
              <tr class="">
                ...
                foreach ($outlet as $items) : ?>
                  ...
                  <td class="text-center">
                    <a href="../private/config/editOutlet?let=<?= $items['id_outlet'] ?>" class="badge btn text-dark"><i class="ri-edit-line"></i></a>
                    <a href="../private/config/delOutlet?let=<?= $items['id_outlet'] ?>" onclick="return confirm('Yakin untuk hapus?')" class="badge btn text-dark"><i class="ri-delete-bin-line"></i></a>
                  </td>
              </tr>
            <?php endforeach; ?>
            </tbody>
